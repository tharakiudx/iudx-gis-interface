...
public class Constants {
  ...
  public static final String INSERT_ADMIN_DETAILS_QUERY =
      "INSERT INTO gis (id, serverUrl, serverPort, isSecure, username, password) " +
          "VALUES ('$1', '$2', '$3', '$4', '$5', '$6')";

  public static final String UPDATE_ADMIN_DETAILS_QUERY =
      "UPDATE gis SET serverUrl='$1', serverPort='$2', isSecure='$3', username='$4', password='$5') " +
          "WHERE id='$6'";

  public static final String DELETE_ADMIN_DETAILS_QUERY =
      "DELETE FROM gis WHERE id = '$1'";
}
