  ...
  stages {
    ...
    stage('Unit Tests and CodeCoverage Test'){
      steps{
        ...
        jacoco classPattern: 'target/classes', execPattern: 'target/jacoco.exec', sourcePattern: 'src/main/java', exclusionPattern:'iudx/gis/server/apiserver/*.class,**/*VertxEBProxy.class,**/Constants.class,**/*VertxProxyHandler.class,**/*Verticle.class,iudx/gis/server/deploy/*.class,iudx/gis/server/databroker/DataBrokerService.java,iudx/gis/server/databroker/DataBrokerServiceImpl.java,iudx/gis/server/apiserver/validation/types/Validator.java,iudx/gis/server/metering/MeteringService.java,iudx/gis/server/cache/CacheService.java'
      }
      post{
        failure{
          script{
